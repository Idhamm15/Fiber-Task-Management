...
import 'package:fibertaskmanager/common/utils.dart';
import 'package:fibertaskmanager/data/models/task.dart';
...
import 'package:fibertaskmanager/presentation/widgets/failed_ui.dart';
        ...
        BlocBuilder<StatEmployeeCubit, Map>(
          builder: (context, state) {
            return GridView.count(
              ...
              children: [
                builItemTaskMenu(
                    'assets/queue_bg.png', 'Tickets', state['Queue']),
                builItemTaskMenu(
          ...
          Expanded(
            child: TextField(
              decoration: InputDecoration(
                hintText: 'search task technician...',
